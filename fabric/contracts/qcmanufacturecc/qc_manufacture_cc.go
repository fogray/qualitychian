...
type ManufactureChaincode struct {
}

func (t *ManufactureChaincode)Init(stub shim.ChaincodeStubInterface) peer.Response{
	return shim.Success(nil)
}

func (t *ManufactureChaincode)Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	if err := shim.Start(new(ManufactureChaincode)); err != nil {
		fmt.Printf("Error starting ManufactureChaincode: %s", err)
	}
}