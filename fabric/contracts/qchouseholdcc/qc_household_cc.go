...
type HouseholdChaincode struct {
}

func (t *HouseholdChaincode)Init(stub shim.ChaincodeStubInterface) peer.Response{
	return shim.Success(nil)
}

func (t *HouseholdChaincode)Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	if err := shim.Start(new(HouseholdChaincode)); err != nil {
		fmt.Printf("Error starting HouseholdChaincode: %s", err)
	}
}