...
type OtherChaincode struct {
}

func (t *OtherChaincode)Init(stub shim.ChaincodeStubInterface) peer.Response{
	return shim.Success(nil)
}

func (t *OtherChaincode)Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	if err := shim.Start(new(OtherChaincode)); err != nil {
		fmt.Printf("Error starting OtherChaincode: %s", err)
	}
}