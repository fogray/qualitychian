...
type MedicineChaincode struct {
}

func (t *MedicineChaincode)Init(stub shim.ChaincodeStubInterface) peer.Response{
	return shim.Success(nil)
}

func (t *MedicineChaincode)Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	if err := shim.Start(new(MedicineChaincode)); err != nil {
		fmt.Printf("Error starting MedicineChaincode: %s", err)
	}
}