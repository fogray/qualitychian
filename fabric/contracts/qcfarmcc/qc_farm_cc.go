...
type FarmChaincode struct {
}

func (t *FarmChaincode)Init(stub shim.ChaincodeStubInterface) peer.Response{
	return shim.Success(nil)
}

func (t *FarmChaincode)Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	if err := shim.Start(new(FarmChaincode)); err != nil {
		fmt.Printf("Error starting FarmChaincode: %s", err)
	}
}