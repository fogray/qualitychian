...
public class ChaincodeUtil {
    ...
    public String uploadOrgInfo(String key, String value){
        ...
        try {
            ...
            res = OrgChainCode.getInstance("peerOrg1").invoke(new String[]{"setOrgInfo",key,value});
        } catch (Exception e) {
    ...
    public String uploadProductInfo(String key, String value){
        ...
        try{
            ...
            res = ProductChainCode.getInstance("peerOrg1").invoke(new String[]{"setProductInfo",key,value,"trace1"});
        }catch (Exception e){
    ...
    public String uploadCheckInfo(String key, String value){
        ...
        try {
            ...
            System.out.println("******uploadCheckInfo="+res);
        } catch (Exception e) {
...
//    public String getTraceInfo(String key, String channel, String chaincode){
	...
	public String getTraceInfoForType2(String channel, Map chainOrganMap, String productCode, String barCode){
		String chaincodeName = (String)chainOrganMap.get("CHAINCODE_NAME");
		String chaincodePath = (String)chainOrganMap.get("CHAINCODE_PATH");
		String chaincodeVer = (String)chainOrganMap.get("CHAINCODE_VERSION");
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
		String res = Trace2ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).getTraceInfoByCode(productCode, barCode);
        return res;
    }
     ...
     * @return
     */
	public String getTraceHistoryForType2(String channel, Map chainOrganMap, String productCode, String barCode){
		String chaincodeName = (String)chainOrganMap.get("CHAINCODE_NAME");
		String chaincodePath = (String)chainOrganMap.get("CHAINCODE_PATH");
		String chaincodeVer = (String)chainOrganMap.get("CHAINCODE_VERSION");
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
		
		String res = Trace2ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).getTraceHistoryByCode(productCode, barCode);
        return res;
    }
	 ...
	 * @return
	 */
    public String deleteTraceInfo(String key, String channel, Map<String, Object> chainOrganMap){
        if (log.isDebugEnabled()){
        ...
        try{
        	if ("1".equals(traceCodeType)) {
            	res = Trace1ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).deleteTraceInfo(key);
            } else if ("2".equals(traceCodeType)) {
            	res = Trace2ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).deleteTraceInfo(key);
            } else if ("3".equals(traceCodeType)) {
            	res = Trace3ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).deleteTraceInfo(key);
            }
            if (log.isDebugEnabled()){
     ...
     * @return
     */
    public String uploadMaterialInfo(String key, String value, String channel, Map<String, Object> chainOrganMap){
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
		
        String res = "";
        try {
			MaterialChainCode.getInstance(peerOrg, channel).setMaterialInfo(key, value);
		} catch (Exception e) {
			e.printStackTrace();
    ...
    /**
     * 查询所属行业链的原料信息
     * @param content {"PRODUCT_CODE":"XXX","MATERIAL_BATCH":"XXX"}
     * @param channel 
     * @param chainOrganMap {CHAINCODE_NAME:'', CHAINCODE_PATH:'', CHAINCODE_VERSION:'', CHAIN_ORGAN_NAME:''}
     * @return
     */
    public String getMaterialInfo(String content, String channel, Map<String, Object> chainOrganMap) {
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
    	String res = "";
        try {
            res = MaterialChainCode.getInstance(peerOrg, channel).getMaterialInfo(content);
        } catch (Exception e) {
    ...
    /**
     * 查询药材链原料历史信息
     * @param content {"PRODUCT_CODE":"","MATERIAL_BATCH":""}
     * @param channel 
     * @param chainOrganMap {CHAINCODE_NAME:'', CHAINCODE_PATH:'', CHAINCODE_VERSION:'', CHAIN_ORGAN_NAME:''}
     * @return
     */
    public String getMaterialHistory(String content, String channel, Map<String, Object> chainOrganMap) {
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
        String res = "";
        try {
            res = MaterialChainCode.getInstance(peerOrg, channel).getHistory(content);
        } catch (Exception e) {
     ...
     * @return
     */
    public String deleteMaterialInfo(String key, String channel, Map<String, Object> chainOrganMap) {
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
        String res = "";
        try {
            res = MaterialChainCode.getInstance(peerOrg, channel).deleteMaterialInfo(key);
        } catch (Exception e) {
     ...
     * @return
     */
    public String uploadCirculationInfo(String key, String value, String channel, Map<String, Object> chainOrganMap){
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
    	String res = "failed";
        try{
            res = CirculationChainCode.getInstance(peerOrg, channel).setTraceInfo(key, value);
        }catch (Exception e){
    ...
    /**
     * 获取药材链流通信息
     * @param content {"PRODUCT_CODE":"XXX","TRACE_CODE":"XXX"}
     * @return
     */
    public String getCirculationInfo(String content, String channel, Map<String, Object> chainOrganMap){
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
    	String res = "";
        try {
            res = CirculationChainCode.getInstance(peerOrg, channel).getTraceInfo(content);
        } catch (Exception e) {
    ...
    /**
     * 获取药材链流通历史信息
     * @param content {"PRODUCT_CODE":"","TRACE_CODE":""}
     * @return
     */
    public String getCirculationHistory(String content, String channel, Map<String, Object> chainOrganMap){
		String peerOrg = (String)chainOrganMap.get("CHAIN_ORGAN_NAME");
    	String res = "";
        try {
            res = CirculationChainCode.getInstance(peerOrg, channel).getHistory(content);
        } catch (Exception e) {
     ...
     * @return
     */
	public String queryTraceKeys(String param, String channel, Map<String, Object> chainOrganMap){
		String traceCodeType = (String)chainOrganMap.get("TRACE_CODE_TYPE");
		String chaincodeName = (String)chainOrganMap.get("CHAINCODE_NAME");
		String chaincodePath = (String)chainOrganMap.get("CHAINCODE_PATH");
		String chaincodeVer = (String)chainOrganMap.get("CHAINCODE_VERSION");
    	...
    	try {
	        if ("1".equals(traceCodeType)) {
					res = Trace1ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).query(new String[]{"queryTraceKeys", param});
	        } else if ("2".equals(traceCodeType)) {
	        	res = Trace2ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).query(new String[]{"queryTraceKeys", param});
	        	
	        } else if ("3".equals(traceCodeType)) {
	        	res = Trace3ChainCode.getInstance(peerOrg, channel, chaincodeName, chaincodePath, chaincodeVer).query(new String[]{"queryTraceKeys", param});
	        }
        } catch (Exception e) {
			log.error("queryTraceKeys--err-->",e);
		}
        return res;
    }
}
